...
namespace ToDoApp
{
    public partial class Panel : MetroFramework.Forms.MetroForm
    {
        ...
        public string str1, str2, str3, str4, str5, x;// id ve durum bilgilerini tutan değişkenler.

        private void btn_3_Click(object sender, EventArgs e)//taskların durumlar arasında geçişini sağlar.
        {                  
            if (dtg_research.Rows.Count != 1)//seçilen task olup olmadığını kontrol eder.
            {
        ...
        private void btn_4_Click(object sender, EventArgs e)//taskların durumlar arasında geçişini sağlar.
        {
            if ( dtg_InProgress.Rows.Count != 1)//seçilen task olup olmadığını kontrol eder.
            {
        ...
        private void btn_5_Click(object sender, EventArgs e)//taskların durumlar arasında geçişini sağlar.
        {
            if (dtg_InProgress.Rows.Count != 1)//seçilen task olup olmadığını kontrol eder.
            {
                x = dtg_InProgress.CurrentRow.Cells["task_id"].Value.ToString();
        ...
        private void btn_6_Click(object sender, EventArgs e)//taskların durumlar arasında geçişini sağlar.
        {
            if (dtg_Check.Rows.Count != 1)//seçilen task olup olmadığını kontrol eder.
            {
        ...
        private void btn_7_Click(object sender, EventArgs e)//taskların durumlar arasında geçişini sağlar.
        {
            if (dtg_Check.Rows.Count != 1)//seçilen task olup olmadığını kontrol eder.
            {
                x = dtg_Check.CurrentRow.Cells["task_id"].Value.ToString();
        ...
        private void btn_8_Click(object sender, EventArgs e)//taskların durumlar arasında geçişini sağlar.
        {
            if (dtg_Done.Rows.Count != 1)//seçilen task olup olmadığını kontrol eder.
            {
        ...
        private void btn_2_Click(object sender, EventArgs e)//taskların durumlar arasında geçişini sağlar.
        {
            if (dtg_research.Rows.Count != 1)//seçilen task olup olmadığını kontrol eder.
            {
                x = dtg_research.CurrentRow.Cells["task_id"].Value.ToString();
        ...
        private void btn_1_Click(object sender, EventArgs e)//taskların durumlar arasında geçişini sağlar.
        {
            if (dtg_todo.Rows.Count != 1)//seçilen task olup olmadığını kontrol eder.
            {
        ...
        {
            Projeler pr = new Projeler();//projeler ekranına gönderir.
            pr.Show();
            this.Close();
        }
        ...
        private void Listele()//taskları durumlarına göre datagridlere doldurur.
        {
            DataSet daset = new DataSet();//datagridleri doldurmak için datasetleri oluşturuyoruz.
