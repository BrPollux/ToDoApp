...
namespace ToDoApp
{
    public partial class Güncelle : MetroFramework.Forms.MetroForm
    {
        ...
        {
            if (txt_GprojeAdi.Text == "")//boşluk olup olmadığını kontrol eder.
            {              
            ...
            else //proje güncellemelerini kayıt eder.
            {
                ...
                komut.Parameters.AddWithValue("@proje_tarih", mdt_Gtarih.Text);
                komut.Parameters.AddWithValue("@proje_tarihTahmin", mdt_Gtahminitarih.Text);
        ...
        private void Güncelle_Load(object sender, EventArgs e)
        {
            ...
            Doldur(Convert.ToInt32(txt_GkartNo.Text));//seçilen rowdaki idyi doldur metoduna gönderir.
        }

        public int Doldur(int a)
        {
            ...
            if (read.Read())
            {
                ...
                mdt_Gtarih.Text = read["proje_tarih"].ToString();
                mdt_Gtahminitarih.Text = read["proje_tarihTahmin"].ToString();
        ...
        private void btn_guncelle2_Click(object sender, EventArgs e)// taskların son halini kayıt eder.
        {
            SqlConnection d = new SqlConnection(conString);
            d.Open();
            ...
            if (txt_GyapilacakIs1.Text != "" && txt_Gaciklama1.Text != "" && cb_Gdurum1.Text != "")//satır boyunca boş bölüm olup olmadığını kontrol eder.
            {
                SqlConnection con = new SqlConnection(conString);
                con.Open();
            ...
            if (txt_GyapilacakIs2.Text != "" && txt_Gaciklama2.Text != "" && cb_Gdurum2.Text != "")//satır boyunca boş bölüm olup olmadığını kontrol eder.
            {
                SqlConnection con = new SqlConnection(conString);
                con.Open();
            ...
            if (txt_GyapilacakIs3.Text != "" && txt_Gaciklama3.Text != "" && cb_Gdurum3.Text != "")//satır boyunca boş bölüm olup olmadığını kontrol eder.
            {
                SqlConnection con = new SqlConnection(conString);
                con.Open();
            ...
            if (txt_GyapilacakIs4.Text != "" && txt_Gaciklama4.Text != "" && cb_Gdurum4.Text != "")//satır boyunca boş bölüm olup olmadığını kontrol eder.
            {
                SqlConnection con = new SqlConnection(conString);
                con.Open();
            ...
            if (txt_GyapilacakIs5.Text != "" && txt_Gaciklama5.Text != "" && cb_Gdurum5.Text != "")//satır boyunca boş bölüm olup olmadığını kontrol eder.
            {
                SqlConnection con = new SqlConnection(conString);
                con.Open();
            ...
            if (txt_GyapilacakIs6.Text != "" && txt_Gaciklama6.Text != "" && cb_Gdurum6.Text != "")//satır boyunca boş bölüm olup olmadığını kontrol eder.
            {
                SqlConnection con = new SqlConnection(conString);
                con.Open();
