...
namespace ToDoApp
{
    public partial class YeniProjeEkle : MetroFramework.Forms.MetroForm
    {
        ...
        private void btn_kaydet1_Click(object sender, EventArgs e)//projeyi kayıt eder.
        {
            
            if (txt_projeAdi.Text == "")//boş alan olup olmadığını kontrol eder.
            {                            
            ...
            else// boş alan yoksa projeyi kayıt eder.
            {                
                ...
                mdt_tahminitarih.Value = sonuc;
                mdt_gerceklesentarih.Value = sonuc;
                ...
                //yeni projenin bilgilerini sqle gönderir.
                komut.Parameters.AddWithValue("@proje_adi", txt_projeAdi.Text);
                komut.Parameters.AddWithValue("@proje_uzman", txt_teknikUzman.Text);
                komut.Parameters.AddWithValue("@proje_tarih", mdt_tarih.Text);
                komut.Parameters.AddWithValue("@proje_tarihTahmin", mdt_tahminitarih.Text);
                ...
                con.Open();
                string giris = "SELECT TOP 1 kartNo_id FROM tbl_proje ORDER BY kartNo_id DESC";// en son eklenen proje idsini alır.
        ...
        private void btn_kaydet2_Click(object sender, EventArgs e)// taskları kayıt eder.
        {
            if (txt_yapilacakIs1.Text != "" && txt_aciklama1.Text != "" && cb_durum1.Text != "")//satır boyunca boş bölüm olup olmadığını kontrol eder.
            {
                SqlConnection con = new SqlConnection(conString);
                con.Open();
            ...
            if (txt_yapilacakIs2.Text != "" && txt_aciklama2.Text != "" && cb_durum2.Text != "")//satır boyunca boş bölüm olup olmadığını kontrol eder.
            {
                SqlConnection con = new SqlConnection(conString);
                con.Open();
            ...
            if (txt_yapilacakIs3.Text != "" && txt_aciklama3.Text != "" && cb_durum3.Text != "")//satır boyunca boş bölüm olup olmadığını kontrol eder.
            {
                SqlConnection con = new SqlConnection(conString);
                con.Open();
            ...
            if (txt_yapilacakIs4.Text != "" && txt_aciklama4.Text != "" && cb_durum4.Text != "")//satır boyunca boş bölüm olup olmadığını kontrol eder.
            {
                SqlConnection con = new SqlConnection(conString);
                con.Open();
            ...
            if (txt_yapilacakIs5.Text != "" && txt_aciklama5.Text != "" && cb_durum5.Text != "")//satır boyunca boş bölüm olup olmadığını kontrol eder.
            {
                SqlConnection con = new SqlConnection(conString);
                con.Open();
            ...
            if (txt_yapilacakIs6.Text != "" && txt_aciklama6.Text != "" && cb_durum6.Text != "")//satır boyunca boş bölüm olup olmadığını kontrol eder.
            {
                SqlConnection con = new SqlConnection(conString);
                con.Open();
            ...
            Projeler pr = new Projeler();//projeler ekranına götürür.
            pr.Show();
            this.Close();

        }

        private void btn_geri_Click(object sender, EventArgs e)// ana ekrana döndürür.
        {
            Main ma = new Main();
            ma.Show();
            this.Close();
